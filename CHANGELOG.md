...
- Moved the coding-convention rules (architecture, blocks, security) out of `docs/planning/AGENTS.md` into a root `AGENTS.md`, so they reach every generated project instead of staying buried with the rest of the starter's internal planning docs.
